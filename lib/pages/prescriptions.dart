...
import 'package:heydoc/pages/dawai_tile.dart';
        ...
        child: Column(children: <Widget>[
          ...
          TextFormField(
            ...
            decoration: textInputDecoration.copyWith(
              hintText:
                  'From :   ${_durStart.day}-${_durStart.month}-${_durStart.year} ',
          ...
          TextFormField(
            ...
            decoration: textInputDecoration.copyWith(
              hintText:
                  'To :     ${_durEnd.day}-${_durEnd.month}-${_durEnd.year} ',
              prefixIcon: Icon(Icons.calendar_today),
            ),
                      ...
                      if (morning)
                        plugin.showNotification(
                          RecievedNotification(
                              ...
                              body: "It is time to take your pill",
                              payload: "test"),
                          Time(9, 0, 0),
                        );
                      if (afternoon)
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Your active prescriptions are displayed here',
                        style: TextStyle(
